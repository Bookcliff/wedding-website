...
const faq = [
    ...
    { title: "What is an NFT?", description: "NFT stands for ('Non-Fungible Token')[https://en.wikipedia.org/wiki/Non-fungible_token]. Russell and Grace have created NFTs as a fun way to uniquely identify your participation in this momentous event. Please see the NFT tab for further information and step-by-step instructions" },
